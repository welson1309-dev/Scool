...
public class maps1 {
    String mapnavn;
    String beskriv;
    ArrayList<String> muligheder;

    public maps1(String mapnavn, String beskriv){
        this.mapnavn=mapnavn;
        this.beskriv=beskriv;
        this.muligheder=new ArrayList<>();
    }
    void givMuligheder(String mulighed){
        muligheder.add(mulighed);
    }    ArrayList<ArrayList<String>> maps=new ArrayList<>();

    ArrayList<String> guild = new ArrayList<>();
    maps1 guild;

    {
        guild = new maps1("Helte guildet\n GuildHeim ");
    }
    guild.givMuligheder("gå ind i den lokale pub");
    maps.add(guild);
    guild.givMuligheder("")
    public static chars player;
    public static int currentLocation;
    public maps1(chars player){
        this.player = player;
